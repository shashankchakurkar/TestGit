...
public class OriginalSystemReference {
    ...
    @XmlElementRef(name = "ReasonCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reasonCode;
    @XmlElementRef(name = "OldOrigSystemReference", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "EndDateActive", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PartyId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    public void setOldOrigSystemReference(JAXBElement<String> value) {
        this.oldOrigSystemReference = value;
    }
